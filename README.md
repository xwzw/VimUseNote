...
# [Windows平台下](#Windows平台下)

- ## [1. Vim的安装](##1.-Vim的安装)

     - ### [1.1 在windows平台下安装vim](###1.1-在windows平台下安装vim)

- ## [2. Vim的四种模式](##2.-Vim的四种模式)

- ### [3. Vimrc文件的配置](##3.-Vimrc文件的配置)

  - #### [3.1 设置文件编码](###3.1-设置文件编码)

  - #### [3.2 显示行号](###3.2-显示行号)

  - #### [3.3 突出显示当前行](###3.3-突出显示当前行)

  - #### [3.4 突出显示当前列](###3.4-突出显示当前列)

  - #### [3.5 设置突出显示行或列的颜色](###3.5-设置突出显示行或列的颜色)

  - #### [3.6 在Vim中启用鼠标](###3.6-在Vim中启用鼠标)

  - #### [3.7 "显示括号匹配"](#3.7-"显示括号匹配")

  - #### [3.8 括号自动匹配](#3.8-括号自动匹配)

  - #### [3.9 设置缩进](#3.9-设置缩进)

  - #### [3.10 设置粘贴模式](#3.10-设置粘贴模式)

  - #### [3.11 设置非可见字符(tab or 空格)可见](#3.11-设置非可见字符(tab-or-空格)可见)

  - #### [3.12 状态行的设置](#3.12-状态行的设置)

  - #### [3.13 显示光标当前位置](#3.13-显示光标当前位置)

  - #### [3.14 打开文件类型检测](#3.14-打开文件类型检测)

  - #### [3.15 ★重要—打开语法高亮显示★](#3.15-★重要—打开语法高亮显示★)

  - #### [3.16 代码折叠](#3.16-代码折叠)

- ### [4. 在Vim中安装并使用插件](#4.-在Vim中安装并使用插件)

  - #### [4.1 ★★★插件管理工具——Vundle★★★](#4.1-★★★插件管理工具——Vundle★★★)

    - ##### [4.1.1 安装Vundle](#4.1.1-安装Vundle)

    - ##### [4.1.2 配置Vundle](#4.1.2-配置Vundle)

    - ##### [4.1.3 安装插件](#4.1.3-安装插件)

    - ##### [4.1.4 卸载插件](#4.1.4-卸载插件)

    - ##### [4.1.5 更新插件](#4.1.5-更新插件)

    - ##### [4.1.6 其它关于配置的说明](#4.1.6-其它关于配置的说明)

  - #### [4.2 史诗级代码补全插件——YouCompleteMe](#4.2-史诗级代码补全插件——YouCompleteMe)

    - ##### [4.2.1 安装前的准备](#4.2.1-安装前的准备)

    - ##### [4.2.2 下载源码](#4.2.2-下载源码)

    - ##### [4.2.3 编译源码](#4.2.3-编译源码)

    - ##### [4.2.4 编译命令举例](#4.2.4-编译命令举例)
